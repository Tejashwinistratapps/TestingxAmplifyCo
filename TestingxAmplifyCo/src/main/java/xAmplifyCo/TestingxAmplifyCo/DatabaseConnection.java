...
/*public static void main(String[] args) throws SQLException {
	...
	public static Connection getDatabaseConnection() {
		...
		try {
			...
			connection = DriverManager.getConnection("jdbc:postgresql://xamplify-postgresql-sfo2-dec-6-backup-jan-24-backup-do-user-134.db.ondigitalocean.com:25060/xamplify-test?sslmode=require", "doadmin", "lc9uz6iftuum6vuj");
