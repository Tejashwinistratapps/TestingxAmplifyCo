...
public class Emailcampaign {
	...
	//	}
		...
		System.out.println(ecampaignName.getAttribute("value"));
		...
		driver.findElement(By.xpath(properties.getProperty("e_prtnrlst_srch"))).sendKeys("TGASoftwares");			//Search for partner list
		Thread.sleep(5000);
		...
		driver.findElement(By.xpath(properties.getProperty("esearch_template"))).sendKeys("email");						//search for template
		Thread.sleep(5000);
	...
	public static String getcurrentecampaignname()
	{
		return y;
	}
